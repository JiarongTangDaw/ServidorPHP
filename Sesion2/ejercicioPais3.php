...
function buscarCapital($pais,$listaCapitales){
    $contador = 0;
    $cont = count($listaCapitales);
    $capital = "";
    do{
        if($listaCapitales[$contador] -> pais === $pais){
            $capital = $listaCapitales[$contador] -> capital;
        };
        $contador++;
    }while($contador < $cont && $capital == "");
    return $capital;
}
...
//tercera columna habitantes
  ...
  foreach($paises as $pais){
    ...
    $capital = buscarCapital($nombre,$capitales);
