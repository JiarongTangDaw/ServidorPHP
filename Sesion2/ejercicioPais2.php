<?php
  ...
  //ordenar para array complejos como objetos
    usort($paises, function($a, $b) {
        return $a->nombre <=> $b->nombre;
    });
    
    
//   sort($paises,2); sort solo funciona con array simples
  ...
  foreach($paises as $pais){
    ...
    if($habitantes > 10000000){
      $tabla .= "<td style='border:2px red solid;'>$habitantes</td>";
      // $tabla .= "<td style=\"border:2px red solid;\">$habitantes</td>";
    }else{
  ...
  echo $tabla;
  /* recomendado tipar las variables, si se va ha usar string todo string, si es integer es todo integer */
?>